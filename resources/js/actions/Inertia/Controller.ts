...
* @route '/location'
*/
const Controller8f1bc66e18536d52cc0b72388786598f = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller8f1bc66e18536d52cc0b72388786598f.url(options),
    method: 'get',
})

Controller8f1bc66e18536d52cc0b72388786598f.definition = {
    methods: ["get","head"],
    url: '/location',
...
* @route '/location'
*/
Controller8f1bc66e18536d52cc0b72388786598f.url = (options?: RouteQueryOptions) => {
    return Controller8f1bc66e18536d52cc0b72388786598f.definition.url + queryParams(options)
}
...
* @route '/location'
*/
Controller8f1bc66e18536d52cc0b72388786598f.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller8f1bc66e18536d52cc0b72388786598f.url(options),
    method: 'get',
})
...
* @route '/location'
*/
Controller8f1bc66e18536d52cc0b72388786598f.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller8f1bc66e18536d52cc0b72388786598f.url(options),
    method: 'head',
})
...
* @route '/location'
*/
const Controller8f1bc66e18536d52cc0b72388786598fForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller8f1bc66e18536d52cc0b72388786598f.url(options),
    method: 'get',
})
...
* @route '/location'
*/
Controller8f1bc66e18536d52cc0b72388786598fForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller8f1bc66e18536d52cc0b72388786598f.url(options),
    method: 'get',
})
...
* @route '/location'
*/
Controller8f1bc66e18536d52cc0b72388786598fForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: Controller8f1bc66e18536d52cc0b72388786598f.url({
...
Controller8f1bc66e18536d52cc0b72388786598f.form = Controller8f1bc66e18536d52cc0b72388786598fForm
/**
* @see \Inertia\Controller::__invoke
* @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
const Controller = {
    '/location': Controller8f1bc66e18536d52cc0b72388786598f,
