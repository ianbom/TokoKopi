...
import { a as home, l as logout, r as dashboard } from "./assets/routes-DbqRfbKV.js";
...
var pages = /* @__PURE__ */ Object.assign({
	"./pages/admin/admin-users/form.tsx": () => import("./assets/form-CXcX4RF5.js"),
	"./pages/admin/admin-users/index.tsx": () => import("./assets/admin-users-CIBixlGp.js"),
	"./pages/admin/audit-logs/index.tsx": () => import("./assets/audit-logs-VUJaNsGo.js"),
	"./pages/admin/banners/form.tsx": () => import("./assets/form-qnrBbQ3Q.js"),
	"./pages/admin/banners/index.tsx": () => import("./assets/banners-C_YwGQL6.js"),
	"./pages/admin/biteship-webhook-logs/index.tsx": () => import("./assets/biteship-webhook-logs-CyTTfLFW.js"),
	"./pages/admin/biteship-webhook-logs/show.tsx": () => import("./assets/show-DXazK6V4.js"),
	"./pages/admin/catalog/shared.tsx": () => import("./assets/shared-B8siit7H.js"),
	"./pages/admin/categories/form.tsx": () => import("./assets/form-3Xif0zue.js"),
	"./pages/admin/categories/index.tsx": () => import("./assets/categories-Dhu625RB.js"),
	"./pages/admin/customer-addresses/form.tsx": () => import("./assets/form-COtIVI-b.js"),
	"./pages/admin/customer-addresses/index.tsx": () => import("./assets/customer-addresses-BYOCQ3RW.js"),
	"./pages/admin/customer-addresses/show.tsx": () => import("./assets/show-DMdxY-qP.js"),
	"./pages/admin/customers/index.tsx": () => import("./assets/customers-IltWsHZk.js"),
	"./pages/admin/customers/show.tsx": () => import("./assets/show-BgJ-JGA4.js"),
	"./pages/admin/dashboard.tsx": () => import("./assets/dashboard-BHWrzz_B.js"),
	"./pages/admin/home-settings/index.tsx": () => import("./assets/home-settings-DX3ObPPF.js"),
	"./pages/admin/marketing/shared.tsx": () => import("./assets/shared-Bw7UdwDD.js"),
	"./pages/admin/notifications/form.tsx": () => import("./assets/form-Cm1jJSdw.js"),
	"./pages/admin/notifications/index.tsx": () => import("./assets/notifications-C-j0PWev.js"),
	"./pages/admin/orders/index.tsx": () => import("./assets/orders-DXxkxDDy.js"),
	"./pages/admin/orders/show.tsx": () => import("./assets/show-Cx255_uu.js"),
	"./pages/admin/pagination.tsx": () => import("./assets/pagination-mGQhs61h.js"),
	"./pages/admin/payment-logs/index.tsx": () => import("./assets/payment-logs-C7Kq6GYR.js"),
	"./pages/admin/payment-logs/show.tsx": () => import("./assets/show-CNcK7-7j.js"),
	"./pages/admin/payments/index.tsx": () => import("./assets/payments-CSRRuLul.js"),
	"./pages/admin/payments/show.tsx": () => import("./assets/show-Ds0o-DRU.js"),
	"./pages/admin/product-variants/form.tsx": () => import("./assets/form-C9b6-Kgo2.js"),
	"./pages/admin/product-variants/index.tsx": () => import("./assets/product-variants-Ugt5Eafh.js"),
	"./pages/admin/products/form.tsx": () => import("./assets/form-wRPqOYJ-.js"),
	"./pages/admin/products/index.tsx": () => import("./assets/products-BN1C8P-D.js"),
	"./pages/admin/products/show.tsx": () => import("./assets/show-DyfpgAH32.js"),
	"./pages/admin/reports/index.tsx": () => import("./assets/reports-T1YAzhds.js"),
	"./pages/admin/sales/shared.tsx": () => import("./assets/shared-zXrnEUqv.js"),
	"./pages/admin/settings/index.tsx": () => import("./assets/settings-DMitiuPO.js"),
	"./pages/admin/shipments/index.tsx": () => import("./assets/shipments-Cpqu4r_M.js"),
	"./pages/admin/shipments/show.tsx": () => import("./assets/show-Cy7vKqow.js"),
	"./pages/admin/stock/adjustment.tsx": () => import("./assets/adjustment-CoAXGnLk.js"),
	"./pages/admin/stock/index.tsx": () => import("./assets/stock-D5YO4Yvm.js"),
	"./pages/admin/vouchers/form.tsx": () => import("./assets/form-a0C_Syq6.js"),
	"./pages/admin/vouchers/index.tsx": () => import("./assets/vouchers-VRGrO73G.js"),
	"./pages/admin/wishlists/index.tsx": () => import("./assets/wishlists-CpoA9jNE.js"),
	"./pages/auth/confirm-password.tsx": () => import("./assets/confirm-password-4xTlTvZK.js"),
	"./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-BmKSlpVF.js"),
	"./pages/auth/login.tsx": () => import("./assets/login-c0fHuqUb.js"),
	"./pages/auth/register.tsx": () => import("./assets/register-Bd4ZXz7n.js"),
	"./pages/auth/reset-password.tsx": () => import("./assets/reset-password-DKCFf3io.js"),
	"./pages/auth/two-factor-challenge.tsx": () => import("./assets/two-factor-challenge-CHBwFWbP.js"),
	"./pages/auth/verify-email.tsx": () => import("./assets/verify-email-Ce6-jImF.js"),
	"./pages/customer/cart/my-cart.tsx": () => import("./assets/my-cart-BEdJnQx5.js"),
	"./pages/customer/checkout/checkout.tsx": () => import("./assets/checkout-hfErrZyO.js"),
	"./pages/customer/manage-address/manage-address.tsx": () => import("./assets/manage-address-DbIriwFp.js"),
	"./pages/customer/notification/list-notification.tsx": () => import("./assets/list-notification-DIS6EAQq.js"),
	"./pages/customer/order/detail-order.tsx": () => import("./assets/detail-order-BM330PbQ.js"),
	"./pages/customer/order/my-order.tsx": () => import("./assets/my-order-DLeAk6Dt.js"),
	"./pages/customer/policy/no-return-policy.tsx": () => import("./assets/no-return-policy-CrVJYi34.js"),
	"./pages/customer/policy/privacy-policy.tsx": () => import("./assets/privacy-policy-I-4LP5sR.js"),
	"./pages/customer/policy/shipping-policy.tsx": () => import("./assets/shipping-policy-CHZyYRIY.js"),
	"./pages/customer/policy/term-condition.tsx": () => import("./assets/term-condition-BppU0XMm.js"),
	"./pages/customer/products/detail-product.tsx": () => import("./assets/detail-product-C-ct0cEi.js"),
	"./pages/customer/products/list-product.tsx": () => import("./assets/list-product-C92sfoL4.js"),
	"./pages/customer/profile/my-profile.tsx": () => import("./assets/my-profile-Bw3EJork.js"),
	"./pages/customer/wishlist/my-wishlist.tsx": () => import("./assets/my-wishlist-86-OR-BV.js"),
	"./pages/dashboard.tsx": () => import("./assets/dashboard-uZJOSeVG.js"),
	"./pages/location.tsx": () => import("./assets/location-B8_6Q79e.js"),
	"./pages/settings/appearance.tsx": () => import("./assets/appearance-TZNLetX-.js"),
	"./pages/settings/profile.tsx": () => import("./assets/profile-DeQxViem.js"),
	"./pages/settings/security.tsx": () => import("./assets/security-DdpMusOM.js"),
	"./pages/welcome.tsx": () => import("./assets/welcome-CGqbiV0h.js")
});
