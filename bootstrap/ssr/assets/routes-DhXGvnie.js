...
* @route '/location'
*/
locationForm.head = (options) => ({
	action: location.url({ [options?.mergeQuery ? "mergeQuery" : "query"]: {
		_method: "HEAD",
		...options?.query ?? options?.mergeQuery ?? {}
	} }),
	method: "get"
...
//#endregion
export { detail as a, location as c, manageAddress as d, myOrder as f, register as g, notifications as h, dashboard as i, login as l, myWishlist as m, cart as n, home as o, myProfile as p, checkout as r, list as s, about as t, logout as u };

//# sourceMappingURL=routes-DhXGvnie.js.map