...
import { t as categories } from "./categories-a12iEptQ.js";
import { t as homeSettings } from "./home-settings-BBvmTtBM.js";
import { a as productVariants } from "./product-variants-ys4RJ_hb.js";
import { o as products } from "./products-BEnK7CN1.js";
import { r as reports } from "./reports-vIQSk0Ll.js";
import { t as settings } from "./settings-WcA4wSQ7.js";
import { n as stock } from "./stock-C2dJcEwi.js";
import { t as ProfileLayout } from "./profile-layout-DCvuxMjz.js";
import { t as ProfileController } from "./ProfileController-vn1cTWKO.js";
import { t as SecurityController } from "./SecurityController-Bl9aXgD6.js";
...
store$4.url = (args, options) => {
	...
	return store$4.definition.url.replace("{order}", parsedArgs.order.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\ShipmentController::store
* @see app/Http/Controllers/Admin/ShipmentController.php:29
...
var shipments$1 = { store: Object.assign(store$4, store$4) };
//#endregion
...
edit$3.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { customerAddress: typeof args.customerAddress === "object" ? args.customerAddress.id : args.customerAddress };
	return edit$3.definition.url.replace("{customerAddress}", parsedArgs.customerAddress.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\CustomerAddressController::edit
* @see app/Http/Controllers/Admin/CustomerAddressController.php:25
...
update$3.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { customerAddress: typeof args.customerAddress === "object" ? args.customerAddress.id : args.customerAddress };
	return update$3.definition.url.replace("{customerAddress}", parsedArgs.customerAddress.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\CustomerAddressController::update
* @see app/Http/Controllers/Admin/CustomerAddressController.php:30
...
destroy$2.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { customerAddress: typeof args.customerAddress === "object" ? args.customerAddress.id : args.customerAddress };
	return destroy$2.definition.url.replace("{customerAddress}", parsedArgs.customerAddress.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\CustomerAddressController::destroy
* @see app/Http/Controllers/Admin/CustomerAddressController.php:37
...
edit$2.url = (args, options) => {
	...
	return edit$2.definition.url.replace("{voucher}", parsedArgs.voucher.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\VoucherController::edit
* @see app/Http/Controllers/Admin/VoucherController.php:35
...
update$2.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { voucher: typeof args.voucher === "object" ? args.voucher.id : args.voucher };
	return update$2.definition.url.replace("{voucher}", parsedArgs.voucher.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\VoucherController::update
* @see app/Http/Controllers/Admin/VoucherController.php:43
...
destroy$1.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { voucher: typeof args.voucher === "object" ? args.voucher.id : args.voucher };
	return destroy$1.definition.url.replace("{voucher}", parsedArgs.voucher.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\VoucherController::destroy
* @see app/Http/Controllers/Admin/VoucherController.php:50
...
var wishlists = { index: Object.assign(index$3, index$3) };
//#endregion
...
edit$1.url = (args, options) => {
	...
	return edit$1.definition.url.replace("{banner}", parsedArgs.banner.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\BannerController::edit
* @see app/Http/Controllers/Admin/BannerController.php:36
...
editForm$1.head = (args, options) => ({
	action: edit$1.url(args, { [options?.mergeQuery ? "mergeQuery" : "query"]: {
		_method: "HEAD",
		...options?.query ?? options?.mergeQuery ?? {}
	} }),
	method: "get"
...
update$1.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { banner: typeof args.banner === "object" ? args.banner.id : args.banner };
	return update$1.definition.url.replace("{banner}", parsedArgs.banner.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\BannerController::update
* @see app/Http/Controllers/Admin/BannerController.php:45
...
destroy.url = (args, options) => {
	...
	args = applyUrlDefaults(args);
	const parsedArgs = { banner: typeof args.banner === "object" ? args.banner.id : args.banner };
	return destroy.definition.url.replace("{banner}", parsedArgs.banner.toString()).replace(/\/+$/, "") + queryParams(options);
};
/**
* @see \App\Http\Controllers\Admin\BannerController::destroy
* @see app/Http/Controllers/Admin/BannerController.php:52
...
//# sourceMappingURL=my-profile-Bw3EJork.js.map