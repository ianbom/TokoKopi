...
import { c as update, i as index, r as edit, s as store } from "./product-variants-ys4RJ_hb.js";
			...
			children: [
				...
				/* @__PURE__ */ jsx(Field, {
					...
					children: /* @__PURE__ */ jsx(Input, {
						...
						onChange: (event) => setField("tasting_notes", event.target.value)
					})
				}),
				/* @__PURE__ */ jsx(Field, {
					label: "Harga normal",
...
//# sourceMappingURL=form-C9b6-Kgo2.js.map