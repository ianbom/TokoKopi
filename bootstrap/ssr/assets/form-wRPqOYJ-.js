...
import { a as index, c as show, l as store, u as update } from "./products-BEnK7CN1.js";
					...
					children: [/* @__PURE__ */ jsx(SectionTitle, {
						...
						children: form.data.variants.map((variant, variantIndex) => /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(Field, {
									label: "Tasting Notes",
									error: errors[`variants.${variantIndex}.tasting_notes`],
									children: /* @__PURE__ */ jsx(Input, {
										placeholder: "Cokelat, jeruk, gula aren",
										value: variant.tasting_notes,
										onChange: (event) => patchVariant(variantIndex, { tasting_notes: event.target.value })
									})
								}),
								/* @__PURE__ */ jsx(Field, {
									label: "Harga normal",
...
//# sourceMappingURL=form-wRPqOYJ-.js.map